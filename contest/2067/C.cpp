...
void solve()
{
    ...
    res = min(res, cntt(9));
    res = min(res, cntt(99));
    res = min(res, cntt(999));
    res = min(res, cntt(9999));
    res = min(res, cntt(99999));
    res = min(res, cntt(999999));
    res = min(res, cntt(99999999));
    res = min(res, cntt(999999999));
    cout << res;
}
